...
from app.survillance.infrastructure.domain_infrastructure import EventoRepository, ClipRepository
from app.survillance.application.services import EventoService
